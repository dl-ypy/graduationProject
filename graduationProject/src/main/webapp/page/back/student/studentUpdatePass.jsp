...
<body>
	<script type="text/javascript">
		...
		/* 保存修改 */
		function update() {
			$('#updateStudentPassForm').form('submit',{
				url:'/graduation/student/updateStudentPass',
				type: "POST",
				onSubmit:function(){
	...
	<div id="updateStudentPass" style="width:100%;height:100%;background: url('/graduation/images/password.jpg');">
		<form id="updateStudentPassForm" style="position:relative; left:40%; top:25%" class="easyui-form" method="post" data-options="novalidate:true">
