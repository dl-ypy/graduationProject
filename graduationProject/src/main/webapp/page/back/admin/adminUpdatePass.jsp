...
<body>
	<script type="text/javascript">
		...
		/* 保存修改 */
		function update() {
			$('#updateAdminPassForm').form('submit',{
				url:'/graduation/admin/updateAdminPass',
				type: "POST",
				onSubmit:function(){
	...
	<div id="updateAdminPass" style="width:100%;height:100%;background: url('/graduation/images/password.jpg');">
		<form id="updateAdminPassForm" style="position:relative; left:40%; top:25%" class="easyui-form" method="post" data-options="novalidate:true">
